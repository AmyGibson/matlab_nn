...
% 
%     temp_seg_hist = flipud(seg_history(1:seg_history_index,1:2));
%     temp_id = find(temp_seg_hist(:,2) < cur_time - 500, 1);
%     if isempty(temp_id)
%         continue;
%     end
%     tar_id = temp_seg_hist(temp_id, 1);
%     time_dif = cur_time - temp_seg_hist(temp_id,2);
