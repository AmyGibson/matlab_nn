function h = plot_gaussian_ellipsoid_contouronly(m, C, sdwidth, npts, edgecolor)
...
switch numel(m)
   ...
   case 3, h=show3d(m(:),C,sdwidth,npts,axh, edgecolor);
   otherwise
...
%-----------------------------
function h = show3d(means, C, sdwidth, npts, axh, edgecolor)
...
h = surf(axh, xp,yp,zp, 'EdgeAlpha', 0.5, 'FaceAlpha', 0, 'EdgeColor', edgecolor);
% hold on
% contour(xp, yp, zp, 1,'LineWidth', 1.5, 'LevelStep', 10, 'Color', [0.5 0.5 0.5] );
% hold on
% contour(zp, yp, xp, 1,'LineWidth', 1.5 );
axis xy
