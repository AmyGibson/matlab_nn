function h = plot_gaussian_side_contour(m, C, sdwidth, npts, axh)
...
% h = surf(axh, xp,yp,zp, 'EdgeAlpha', 0.1);
hold on
% h = contour(xp, yp, zp, 1,'LineWidth', 1.5, 'Color', [0.5 0.5 0.5] );
% hold on
h = contour(zp, yp, xp, 1,'LineWidth', 1.5, 'Color', [0.5 0.5 0.5] );
axis xy
